...
function drawRanking(interpolatedPositions) {
    ...
    ranking.forEach((item, i) => {
        ...
        ctx.textAlign = "center";
        ctx.textBaseline = "middle";
        ctx.fillText(horse.number, startX + boxSize / 2, y + boxSize / 2);
    });
}
